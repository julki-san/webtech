<?php
session_start(); // Make sure you have session started if you are using sessions

$display_content = 'Look Great!'; // Default welcome message

if (isset($_SESSION['username'])) {
    $loggedInUsername = $_SESSION['username'];
    $display_content = "Welcome back, " . htmlspecialchars($loggedInUsername) . "!";
}
?>
<!DOCTYPE html>
<html lang="en">
...
<header>
    ...
    <div class="header-content">
      <div class="content">
        <p><?php echo htmlspecialchars($display_content ?? 'Welcome!'); ?></p> </div>
      <div class="dp">
  ...
  <div class="main-container">
      ...
      <nav class="nav">
        <div class="nav-upper-options">
          <div class="nav-option option4">
            <img src="../images/dash.png" class="nav-img" alt="dashboard" />
          ...
          <div class="option2 nav-option">
            <img src="../images/booking.png" class="nav-img" alt="articles" />
            <a href="booklist.php">
              <h3>Booking List</h3>
            </a>
          </div>
          <div class="nav-option option1">
            <img src="../images/report.png" class="nav-img" alt="institution" />
            <a href="report.php">
              <h3>Report</h3>
            </a>
          </div>
    ...
    <div class="main">
      ...
      <div class="dashboard">
        <h2>Total Services by Type</h2>
        <canvas id="servicesChart" width="800" height="400"></canvas>

        <script>
          async function fetchServiceData() {
            try {
              const response = await fetch("get_service_counts.php");
            ...
            new Chart(ctx, {
              ...
              options: {
                ...
                plugins: {
                  ...
                  title: { display: true, text: "Total Services by Type" },
                },
              },
            });
          }
...
document.addEventListener('DOMContentLoaded', function() {
    const welcomeMessage = "<?php echo htmlspecialchars($display_content ?? 'Welcome!'); ?>";
